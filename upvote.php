...
if($LatestSql = $db->prepare("SELECT * FROM voteip LEFT JOIN media ON voteip.media_id=media.id WHERE voteip.uid='$pid' ORDER BY voteip.id and voteip.type=1 DESC LIMIT 0, 10")){
	$LatestSql->execute();
