...
if ($delete == 'yes'){
//find the image
$imgdata = $db->prepare("SELECT * FROM media WHERE id='$del'");
$imgdata->execute();
$image = $imgdata->fetch();	
...
$UpdateMedia1 = $db->prepare("UPDATE media SET feat='1' WHERE id='$fid'");
$UpdateMedia1->execute();
...
$UpdateMedia2 = $db->prepare("UPDATE media SET feat='0' WHERE id='$unfid'");
$UpdateMedia2->execute();
...
$UpdateMedia3 = $db->prepare("UPDATE media SET active='0' WHERE id='$des'");
$UpdateMedia3->execute();
...
<?php
	...
	*/
	$query = $db->prepare("SELECT COUNT(*) as num FROM media WHERE active='1' and (type=1 or type=2) ORDER BY id DESC");
	$query->execute();
	...
	/* Get data. */
	$result = $db->prepare("SELECT * FROM media WHERE active='1' and (type=1 or type=2) ORDER BY id DESC LIMIT $start, $limit");
	$result->execute();
...
<?=$pagination?>
<?php
$q = $db->prepare("SELECT * FROM media WHERE active='1' and (type=1 or type=2) ORDER BY id desc LIMIT $start,$limit");
$q->execute();
