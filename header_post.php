...
if($PostSql = $db->prepare("SELECT * FROM media WHERE id='$pid'")){
	$PostSql->execute();

$PostRow = $PostSql->fetch();
...
$UpdatePostViews = $db->prepare("UPDATE media SET views=views+1 WHERE id='$MediaId'");
$UpdatePostViews->execute();
