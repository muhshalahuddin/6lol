...
if($LatestSql = $db->prepare("SELECT * FROM comments LEFT JOIN media ON comments.pid=media.id WHERE comments.uid='$pid' ORDER BY comments.id DESC LIMIT 0, 10")){
$LatesSql->execute();
while ($LatestRow = $LateSql->fetch()){
